        ...
        this.supportedAccessories.forEach((acc) => {
            ...
            acc.fakeGato = {
                room: {
                    ...
                    ppm: [
                        has(Service.CarbonDioxideSensor, Characteristic.CarbonDioxideLevel),
                        has(Service.AirQualitySensor, Characteristic.PM2_5Density),
                        has(Service.AirQualitySensor, Characteristic.PM10Density),
                        has(Service.CarbonMonoxideSensor, Characteristic.CarbonMonoxideLevel),
                    ].find((i) => i !== undefined),
                },
                motion: {
